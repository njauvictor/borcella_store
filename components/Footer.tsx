...
function Footer() {
  return (
    <section className="px-16 py-10 bg-green1 sm:pt-16 lg:pt-24">
    <div className="px-4 mx-auto sm:px-4 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-12">
            ...
            <Link href="/">
                ...
                <ul className="mt-8 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Home </a>
                    </li>

                    <li>
                        <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Shop </a>
                    </li>

                    <li>
                        <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Contact </a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul className="mt-8 space-y-4">
                    <li>
                        <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> New Arrivals </a>
                    </li>

                    <li>
                        <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Featured Products </a>
                    </li>

                    <li>
                        <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Best Selling </a>
                    </li>

                    <li>
                        <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> All Products </a>
                    </li>
                </ul>
            </div>

            <div>
                <p className="-text-sm font-semibold text-white">Extra Links</p>
        ...
        <div className="mt-20 md:mt-28 2xl:mt-32">
            <div className="lg:flex lg:items-center lg:justify-between">
                ...
                <p className="mt-6 text-sm text-blue-200 lg:mt-0">© Copyright 2024, All Rights Reserved by VictorMaina.Tech</p>
            </div>
        </div>
    </div>
</section>
