...
const Hero: React.FC = () => {
  return (
    <section className="hero min-h-screen bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(/banner2.png)` }}>
      <div className="container mx-auto px-5 sm:px-1 lg-10  py-20 flex flex-col items-start justify-center h-full"> <h5 className="text-xs font-semibold text-grey opacity-60 uppercase tracking-widest leading-snug mt-8">Welcome to Our Store</h5>
